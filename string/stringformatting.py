def print_formatted(number):
    ...
    for i in range (1,number+1):
        ...
        w=len(c)+1
        print((str(i).rjust(w-1))+(o.rjust(w))+(x.rjust(w))+(b.rjust(w)))
...
from 1 to number. Each value should be space-padded to match the width of the binary value of number
